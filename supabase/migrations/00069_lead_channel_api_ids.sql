-- LINE user ID / Facebook PSID จาก OAuth บนฟอร์ม /contact
...
COMMENT ON COLUMN public.leads.line_user_id IS
  'LINE Login user ID (sub) จาก OAuth บนฟอร์มติดต่อ';

COMMENT ON COLUMN public.leads.facebook_psid IS
  'Facebook user ID จาก FB Login บนฟอร์มติดต่อ (PSID จริงอาจมาจาก Messenger webhook ภายหลัง)';
