-- Hotfix: 00069 REVOKE/GRANT used 14-arg signature; function has 15 params.
-- Idempotent: drop all overloads, recreate, grant.
...
BEGIN
  FOR r IN
    ...
    WHERE n.nspname = 'public'
      AND p.proname = 'submit_public_inquiry'
  LOOP
    EXECUTE format('DROP FUNCTION IF EXISTS public.submit_public_inquiry(%s)', r.args);
  END LOOP;
END $$;
